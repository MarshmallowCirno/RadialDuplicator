...
class RADDUPLICATOR_OT_radial_screw_refresh(bpy.types.Operator):
    """Refresh screw on the active object"""

    bl_idname = "radial_duplicator.screw_refresh"
    bl_label = "Refresh Screw"
...
classes = (
    RADDUPLICATOR_OT_radial_screw_refresh,
)
